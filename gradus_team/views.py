...
class ShowGame(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['goals_HT'] = GoalAssist.objects.filter(team_goal=context['game'].home_team, game_goal=context['game'])
        context['goals_GT'] = GoalAssist.objects.filter(team_goal=context['game'].guest_team, game_goal=context['game'])
